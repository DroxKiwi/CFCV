export default function printBottomCardJS() {
    return (`
        ...
        return (
            <div>
                <DragMove onDragMove={handleDragMove}>
                    <div style={{transform: "translateY({translate.y}px)"}} onClick={handleIsRunningChange} className="block fixed inset-x-0 bottom-0 bg-slate-800 fixed w-full h-[61%] z-0 overflow-visible cursor-pointer hover:shadow-inner hover:shadow-gray-50/50 rounded-md">
